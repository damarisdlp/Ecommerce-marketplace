...
const Main = () => {
  ...
  const layoutlessRoutesLI = useMemo(() => getLayoutlessRoutes({ data: routesAndMenuItemsLI }), []);
    ...
    <Provider store={store}>
      <PersistGate loading={null} persistor={persistedStore}>
        ...
        <Router basename={process.env.REACT_APP_BASENAME}>
          <LangProvider>
            <RouteIdentifier routes={[...layoutlessRoutesLI, ...defaultRoutes]} fallback={<Loading />} />
          </LangProvider>
        </Router>
      </PersistGate>
    </Provider>
