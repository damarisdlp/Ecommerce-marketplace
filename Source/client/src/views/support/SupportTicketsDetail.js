...
const SupportTicketsDetail = () => {
  ...
  const description = 'Suport Ticket Details page';
        ...
        <div className="page-title-container mb-3">
          <Row>
            ...
            <Col xs="12" sm="auto" className="d-flex align-items-center justify-content-end">
              <Dropdown className="ms-1 w-100 w-md-auto" align="end" onSelect={handleSelect}>
                <Dropdown.Toggle className="end w-100 w-md-auto" variant="outline-primary">
                  Status: {status}
                </Dropdown.Toggle>
                <Dropdown.Menu>
                  <Dropdown.Item eventKey="Solved">Status: Solved</Dropdown.Item>
                  <Dropdown.Item eventKey="Active">Status: Active</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
          ...
          <Row>
            <Col xxl="8" className="mb-5 mb-xxl-0">
              ...
              <h2 className="small-title">Renter credit card charge-back?</h2>
              <Card className="mb-2">
                <Card.Body>
                  <div className="mb-4 pb-4 border-bottom border-separator-light">
                    <Row className="g-0 sh-sm-5 h-auto">
                      <Col xs="auto">
                        <img src={currentUser.thumb} className="card-img rounded-xl sh-5 sw-5" alt="thumb" />
                      </Col>
                      <Col className="ps-3">
              ...
              <Card>
                <Card.Body>
                  ...
                  <Button variant="outline-primary" className="btn-icon btn-icon-end" disabled>
                    <span>Send</span> <CsLineIcons icon="send" />
                  </Button>
                  <Button variant="outline-primary" className=" btn-icon btn-icon-only ms-1" disabled>
