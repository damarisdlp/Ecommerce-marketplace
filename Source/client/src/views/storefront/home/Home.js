...
const Home = () => {
  ...
  // Get auth state values at page load
  const { currentUser, isLogin } = useSelector((state) => state.auth);
  const dispatch = useDispatch();

  // Greet user by name
  function UserGreeting(props) {
    return <h3>Welcome back, {currentUser.name}</h3>;
  }
  ...
  // Determine which greeting to render
  function Greeting(props) {
    if (isLogin) {    return <UserGreeting />;  }  return <GuestGreeting />;}
  ...
  return (
    <>
      ...
      <Row className="g-2 row-cols-2 row-cols-md-4 row-cols-xl-8 mb-5">
        <Col className="sh-19">
          <Card className="h-100 hover-border-primary">
          <Card.Img src="/img/product/categories/bikes.png" alt="bikes" className="h-100 hover-border-primary"/>
            <Card.Body className="text-center" >
            <Card.ImgOverlay className="sh-19">
              <NavLink to="/storefront/categories">
                <p className="heading mt-3 text-body" style={{color:'white', background:'white'}}>Bikes</p>
                <p> </p>
        ...
        <Col className="sh-19">
          <Card className="h-100 hover-border-primary">
          <Card.Img src="/img/product/categories/tools.png" alt="bikes"className="h-100 hover-border-primary"/>
            <Card.Body className="text-center">
            <Card.ImgOverlay>
              <NavLink to="/storefront/categories">
                <p className="heading mt-3 text-body" style={{color:'white', background:'white'}}>Tools</p>
                <p> </p>
        ...
        <Col className="sh-19">
          <Card className="h-100 hover-border-primary">
          <Card.Img src="/img/product/categories/cameras.png" alt="cameras"className="h-100 hover-border-primary"/>
            <Card.Body className="text-center">
            <Card.ImgOverlay>
              <NavLink to="/storefront/categories">
                <p className="heading mt-3 text-body" style={{color:'white', background:'white'}}>Cameras</p>
                <p> </p>
        ...
        <Col className="sh-19">
          <Card className="h-100 hover-border-primary">
          <Card.Img src="/img/product/categories/camping.png" alt="camping"className="h-100 hover-border-primary"/>
            <Card.Body className="text-center">
            <Card.ImgOverlay>
              <NavLink to="/storefront/categories">
                <p className="heading mt-3 text-body" style={{color:'white', background:'white'}}>Camping</p>
                <p> </p>
        ...
        <Col className="sh-19">
          <Card className="h-100 hover-border-primary">
          <Card.Img src="/img/product/categories/ev.png" alt="ev"className="h-100 hover-border-primary"/>
            <Card.Body className="text-center">
            <Card.ImgOverlay>
              <NavLink to="/storefront/categories">
                <p className="heading mt-3 text-body" style={{color:'white', background:'white'}}>Electric Vehicles</p>
                <p> </p>
                <div className="text-extra-small fw-medium text-muted">3 PRODUCTS</div>
              </NavLink>
              </Card.ImgOverlay>
        ...
        <Col className="sh-19">
          <Card className="h-100 hover-border-primary">
          <Card.Img src="/img/product/categories/sports.png" alt="sports"className="h-100 hover-border-primary"/>
            <Card.Body className="text-center">
            <Card.ImgOverlay>
              <NavLink to="/storefront/categories">
                <p className="heading mt-3 text-body" style={{color:'white', background:'white'}}>Sports Equipment</p>
        ...
        <Col className="sh-19">
          <Card className="h-100 hover-border-primary">
          <Card.Img src="/img/product/categories/gardening.png" alt="gardening"className="h-100 hover-border-primary"/>
            <Card.Body className="text-center">
            <Card.ImgOverlay>
              <NavLink to="/storefront/categories">
                <p className="heading mt-3 text-body" style={{color:'white', background:'white'}}>Gardening</p>
                <div className="text-extra-small fw-medium text-muted">4 PRODUCTS</div>
              </NavLink>
              </Card.ImgOverlay>
            </Card.Body>
        ...
        <Col className="sh-19">
          <Card className="h-100 hover-border-primary">
          <Card.Img src="/img/product/categories/film.png" alt="film"className="h-100 hover-border-primary"/>
            <Card.Body className="text-center">
            <Card.ImgOverlay>
              <NavLink to="/storefront/categories">
                <p className="heading mt-3 text-body" style={{color:'white', background:'white'}}>Film Equipment</p>
                <div className="text-extra-small fw-medium text-muted">4 PRODUCTS</div>
              </NavLink>
              </Card.ImgOverlay>
            </Card.Body>
