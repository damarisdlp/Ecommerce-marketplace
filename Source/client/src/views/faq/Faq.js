        ...
        <Col xl="8" xxl="9" className="mb-5">
          ...
          <Accordion className="mb-n2" defaultActiveKey="1">
            <Card className="d-flex mb-2 flex-grow-1">
              <CustomAccordionToggle eventKey="1">How do I get started?</CustomAccordionToggle>
            ...
            <Card className="d-flex mb-2 flex-grow-1">
              <CustomAccordionToggle eventKey="2">What items can I list?</CustomAccordionToggle>
            ...
            <Card className="d-flex mb-2 flex-grow-1">
              <CustomAccordionToggle eventKey="3">How do I find items?</CustomAccordionToggle>
            ...
            <Card className="d-flex mb-2 flex-grow-1">
              <CustomAccordionToggle eventKey="4">How do I resolve a dispute?</CustomAccordionToggle>
            ...
            <Card className="d-flex mb-2 flex-grow-1">
              <CustomAccordionToggle eventKey="5">How do I pay for an item?</CustomAccordionToggle>
            ...
            <Card className="d-flex mb-2 flex-grow-1">
              <CustomAccordionToggle eventKey="6">Who am I?</CustomAccordionToggle>
        ...
        <Col xl="4" xxl="3">
          ...
          <Card className="mb-2">
            <Card.Body>
              ...
              <div className="text-muted mb-4">Cheesecake chocolate carrot cake pie lollipop lemon toffee lollipop. Oat cake pie cake cotton.</div>
              <Button variant="outline-primary" className="btn-icon btn-icon-start sw-15 stretched-link" disabled>
