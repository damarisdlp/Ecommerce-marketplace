...
const AccountBilling = () => {
  ...
  const breadcrumbs = [
    ...
    { to: 'accountBilling', title: 'Billing' },
  ];
    ...
    <>
      ...
      <Row>
        <Col>
                      ...
                      <Row className="g-0">
                        <Col xs="auto">
                          <div className="bg-gradient-light sw-5 sh-5 rounded-xl d-flex justify-content-center align-items-center">
                            <CsLineIcons icon="invoice" className="text-white" />
                          </div>
                        </Col>
                        <Col>
                  ...
                  <Card>
                    <Card.Body className="h-100 py-5 align-items-center">
                      <Row className="g-0">
                        ...
                        <Col>
                          <div className="sh-5 d-flex align-items-center lh-1-25 ps-3">This Months Estimated Income</div>
                        </Col>
                        <Col xs="auto" className="d-flex align-items-center">
                  ...
                  <Card>
                    <Card.Body className="h-100 py-5 align-items-center">
                      <Row className="g-0">
                        <Col xs="auto">
                          <div className="bg-gradient-light sw-5 sh-5 rounded-xl d-flex justify-content-center align-items-center">
                            <CsLineIcons icon="cloud-upload" className="text-white" />
                          </div>
                        </Col>
                        <Col>
                          <div className="sh-5 d-flex align-items-center lh-1-25 ps-3">Number of Items on Rent</div>
                        </Col>
                        <Col xs="auto" className="d-flex align-items-center">
                          <div className="cta-2 text-primary">6</div>
                        </Col>
                      </Row>
                    </Card.Body>
                  </Card>
                  ...
                  <Card>
                    <Card.Body className="h-100 py-5 align-items-center">
                      <Row className="g-0">
                        <Col xs="auto">
                          <div className="bg-gradient-light sw-5 sh-5 rounded-xl d-flex justify-content-center align-items-center">
                            <CsLineIcons icon="cloud-download" className="text-white" />
                          </div>
                        </Col>
                        <Col>
                          <div className="sh-5 d-flex align-items-center lh-1-25 ps-3">Number of Items Out for Rent</div>
                        </Col>
                        <Col xs="auto" className="d-flex align-items-center">
                ...
                <Card.Body className="h-100">
                  <Row className="g-0">
                    ...
                    <Col xs="12" className="col-sm">
                      <h4 className="mb-4">Search Rental History</h4>
                      <Form>
                        <div className="mb-4 filled">
                          <CsLineIcons icon="invoice" />
                          <Form.Control type="search" placeholder="Search Rental History" />
                        </div>
          ...
          <h2 className="small-title">Rental History</h2>
          <Card>
            <Card.Body>
