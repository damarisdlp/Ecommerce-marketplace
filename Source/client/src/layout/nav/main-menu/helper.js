...
// changed status 4 from vertical to horizontal in code below line 43
// 4 {selected: 'vertical',    dimension: 'tablet|desktop', html-data: 'horizontal',   view: 'horizontal' }
...
export const checkPlacement = ({ placement, breakpoints }) => {
  ...
  if (placement === MENU_PLACEMENT.Vertical) {
    ...
    /* Changed this section from vertical to horizontal */
    // Adding vertical menu for desktop
    return {
      status: 4,
      // changed from MENU_PLACEMENT.Horizontal
      placementHtmlData: MENU_PLACEMENT.Horizontal,
      dimensionHtmlData: DIMENSION.Desktop,
      // changed from MENU_PLACEMENT.Horizontal
      view: MENU_PLACEMENT.Horizontal,
